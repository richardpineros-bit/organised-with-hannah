...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-20">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(/images/contact-bg.jpg)' }}>
        ...
        <div className="bg-white p-8 md:p-12 shadow-lg">
          ...
          <div className="mt-8 pt-8 border-t space-y-4">
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-600">{getValue('contact', 'phone', '0412 345 678')}</span>
            </div>
            <div className="flex items-center gap-4">
              <MessageSquare className="w-5 h-5 text-primary" />
              <span className="text-gray-600">{getValue('contact', 'email', 'hannah@organisedwithhannah.com')}</span>
            </div>
            <div className="flex items-center gap-4">
              <MapPin className="w-5 h-5 text-primary" />
              <span className="text-gray-600">{getValue('contact', 'location', 'Albury / Wodonga and surrounds')}</span>
            </div>
          </div>
        </div>
      </div>
